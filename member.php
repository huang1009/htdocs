...
<body>
    <div class="container-fluid m-0 p-0">
        ...
        <div class="row m-auto" style="background-image:url(img/01.jpg);background-position:center;background-size:100% 100%;">
            <div class="p-0 m-auto col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 pt-9" style="padding:10%">
                <div class="col-12">
